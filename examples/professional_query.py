...
searches = ['engineer', 'accountant', 'lawyer', 'designer', 'consultant', 'researcher']
...
for counter in range(2):
    if counter == 0: 
        for search in searches:
            ...
            df.to_csv("C:/Users/User/py-linkedin-jobs-scraper/examples/professional.csv", mode='a', sep=',',header=False, index=False)
